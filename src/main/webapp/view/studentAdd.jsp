...
<script>
    ...
    function studnetAdd() {
        ...
        $.ajax({
            ...
            data:{"number":number,"name":name,"enthic":enthic,"sex":sex,
                "institution":institution,"major":major,"grade":grade,
                "clazzNumber":clazzNumber,"fromSchool":fromSchool,"phone":phone}
        });
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><input id="enthic" type="text"/></td>
                    ...
                    <tr>
                        ...
                        <td ><input id="clazzNumber" type="text"/></td>
                        <td class="rightAlign">来源学校：</td>
                        <td><input id="fromSchool" type="text"/></td>
                    </tr>
                    <tr>
